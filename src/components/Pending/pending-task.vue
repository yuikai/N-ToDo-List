<template>
  <div class="pending-container">
    <table class="pending table" v-if="taskCount > 0">
      <thead>
        <th scope="col" class="col-auto">#</th>
        <th scope="col" class="col-auto">userId</th>
    ...
    <p id="placeholder" v-if="taskCount === 0">There is no pending task :)</p>
